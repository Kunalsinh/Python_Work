...
Litter = float(
    input('Enter How much Littler you want to be convertetd into MiliLitter :'))
MiliLitter = 1000
...
print(
    'Display the first character of the string using negative index[-34] :', sentence[-34])
...
names = ['Amit', 'Ambrish', 'Jayesh', 'Jaydeep', 'Rajesh',
         'Abhisek', 'Suraj', 'Ramesh', 'Rakesh', 'Naman', 'Kirit']
